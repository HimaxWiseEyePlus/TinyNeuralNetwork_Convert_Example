...
def main_worker(args):
    ...
    with torch.no_grad():
        ...
        converter = TFLiteConverter(ptq_model, dummy_input, tflite_path='out/ptq_model.tflite',quantize_input_output_type="int8",fuse_quant_dequant=True,quantize_target_type="int8")
        converter.convert()
